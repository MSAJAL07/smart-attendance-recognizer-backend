...
module.exports = (err, req, res, next) => {
    ...
    if (err.isOperational) {
        ...
        //   const email= email_temp.email;
        //   const subject = email_temp.subject;
        //   const body = email_temp.generateTemplate(err.statusCode,err);
        //   const mailObj = {
        //     user_email: email,
        //     subject_detail: subject,
        //     email_temp: body,
        //   };
        //   await generalService.sendMail(mailObj);
        // res.status(500).json({
